...
export type ActiveFeatureFlag = (typeof ActiveFeatureFlag)[keyof typeof ActiveFeatureFlag];
export const ActivePlatformFlag = {
  ...
  LwwCanvasForceAll: "LWW_CANVAS_FORCE_ALL",
...
export type ActivePlatformFlag = (typeof ActivePlatformFlag)[keyof typeof ActivePlatformFlag];
export const ActiveProjectFeatureFlag = {
  LwwCanvas: "LWW_CANVAS",
  Placeholder: "PLACEHOLDER",
} as const;

export type ActiveProjectFeatureFlag = (typeof ActiveProjectFeatureFlag)[keyof typeof ActiveProjectFeatureFlag];
...
export type ActiveServiceFeatureFlag = (typeof ActiveServiceFeatureFlag)[keyof typeof ActiveServiceFeatureFlag];
...
export const CertificateErrorType = {
...
export type CertificateErrorType = (typeof CertificateErrorType)[keyof typeof CertificateErrorType];
...
export const CertificateStatusDetailed = {
...
export type CertificateStatusDetailed = (typeof CertificateStatusDetailed)[keyof typeof CertificateStatusDetailed];
...
export type CnameCheckStatus = (typeof CnameCheckStatus)[keyof typeof CnameCheckStatus];
...
export type DnsRecordPurpose = (typeof DnsRecordPurpose)[keyof typeof DnsRecordPurpose];
...
export type DeploymentEventStep = (typeof DeploymentEventStep)[keyof typeof DeploymentEventStep];
...
export type DeploymentInstanceStatus = (typeof DeploymentInstanceStatus)[keyof typeof DeploymentInstanceStatus];
...
export const EnvironmentPatchStatus = {
  Applying: "APPLYING",
  Committed: "COMMITTED",
  Staged: "STAGED",
} as const;

export type EnvironmentPatchStatus = (typeof EnvironmentPatchStatus)[keyof typeof EnvironmentPatchStatus];
...
export const FunctionRuntimeName = {
  Bun: "bun",
} as const;

export type FunctionRuntimeName = (typeof FunctionRuntimeName)[keyof typeof FunctionRuntimeName];
...
export type MetricMeasurement = (typeof MetricMeasurement)[keyof typeof MetricMeasurement];
...
export const MonitorAlertResourceType = {
  Service: "SERVICE",
  Volume: "VOLUME",
} as const;

export type MonitorAlertResourceType = (typeof MonitorAlertResourceType)[keyof typeof MonitorAlertResourceType];
...
export const MonitorThresholdCondition = {
  Above: "above",
  Below: "below",
} as const;

export type MonitorThresholdCondition = (typeof MonitorThresholdCondition)[keyof typeof MonitorThresholdCondition];
...
export type ObservabilityDashboardItemType = (typeof ObservabilityDashboardItemType)[keyof typeof ObservabilityDashboardItemType];
...
export const PlatformFeatureFlag = {
  AllowReplicaMetrics: "ALLOW_REPLICA_METRICS",
  BuilderV3RolloutExistingServices: "BUILDER_V3_ROLLOUT_EXISTING_SERVICES",
  BuilderV3RolloutExistingServicesPro: "BUILDER_V3_ROLLOUT_EXISTING_SERVICES_PRO",
  BuilderV3RolloutNewServices: "BUILDER_V3_ROLLOUT_NEW_SERVICES",
...
export type PlatformFeatureFlag = (typeof PlatformFeatureFlag)[keyof typeof PlatformFeatureFlag];
...
export const PlatformFeatureFlagType = {
  Boolean: "BOOLEAN",
  Percentage: "PERCENTAGE",
} as const;

export type PlatformFeatureFlagType = (typeof PlatformFeatureFlagType)[keyof typeof PlatformFeatureFlagType];
...
export type ProjectUsageProperty = (typeof ProjectUsageProperty)[keyof typeof ProjectUsageProperty];
...
export const ReplicateVolumeInstanceSnapshotStatus = {
  Completed: "COMPLETED",
  Failed: "FAILED",
  Initiated: "INITIATED",
...
export type ReplicateVolumeInstanceSnapshotStatus =
  (typeof ReplicateVolumeInstanceSnapshotStatus)[keyof typeof ReplicateVolumeInstanceSnapshotStatus];
/** The status of a volume instance replication */
export const ReplicateVolumeInstanceStatus = {
  Completed: "COMPLETED",
  Error: "ERROR",
  Queued: "QUEUED",
...
export type ReplicateVolumeInstanceStatus = (typeof ReplicateVolumeInstanceStatus)[keyof typeof ReplicateVolumeInstanceStatus];
...
export type RestartPolicyType = (typeof RestartPolicyType)[keyof typeof RestartPolicyType];
...
export type SubscriptionModel = (typeof SubscriptionModel)[keyof typeof SubscriptionModel];
...
export type SupportTierOverride = (typeof SupportTierOverride)[keyof typeof SupportTierOverride];
...
export const TwoFactorMethodCompliance = {
  Authenticator: "AUTHENTICATOR",
  Passkey: "PASSKEY",
} as const;

export type TwoFactorMethodCompliance = (typeof TwoFactorMethodCompliance)[keyof typeof TwoFactorMethodCompliance];
export const TwoFactorMethodProjectWorkspace = {
  Authenticator: "AUTHENTICATOR",
  Passkey: "PASSKEY",
} as const;

export type TwoFactorMethodProjectWorkspace = (typeof TwoFactorMethodProjectWorkspace)[keyof typeof TwoFactorMethodProjectWorkspace];
...
export type VolumeInstanceBackupScheduleKind = (typeof VolumeInstanceBackupScheduleKind)[keyof typeof VolumeInstanceBackupScheduleKind];
...
export type WithdrawalPlatformTypes = (typeof WithdrawalPlatformTypes)[keyof typeof WithdrawalPlatformTypes];
...
export const WorkspaceIdPConnectionStatus = {
  Active: "ACTIVE",
  Draft: "DRAFT",
  Inactive: "INACTIVE",
  Pending: "PENDING",
...
export type WorkspaceIdPConnectionStatus = (typeof WorkspaceIdPConnectionStatus)[keyof typeof WorkspaceIdPConnectionStatus];
